module github.com/Mic92/dotfiles/pkgs/nostr-chatd

go 1.25

// Tracks gitnostr.com/.../nostrlib master plus three race fixes: subMany
...
replace fiatjaf.com/nostr => github.com/Mic92/nostr v0.0.0-20260412120438-549f7af74682
